...
| class_unlocks | array of string (enum: explorer, dragoon, sage, ranger, alchemist_knight, bard) | No | v0.1 | No | Character classes unlocked on this account. Always contains at least `explorer`. |
...
Creates a new player account. The new account starts with `explorer` unlocked (the default class), an empty Vault with 0 chits, all three meld skills at level 1 with 0 XP, and only the Center Hub unlocked.
...
{"player": {"player_id": "0195c9a2-7b1e-7f3a-9d2c-4e5f6a7b8c9d", "username": "MazeRunner_88", "created_at": "2026-07-11T10:30:00Z", "active_title": null, "class_unlocks": ["explorer"], "meld_skills": [{"skill_kind": "forging", "level": 1, "xp": 0}, {"skill_kind": "mercantile", "level": 1, "xp": 0}, {"skill_kind": "alchemy", "level": 1, "xp": 0}]}}
```
...
```json
HTTP/1.1 200 OK
{"session_token": "mw-sess-0195c9a4-example-opaque-token", "token_type": "Bearer", "expires_in": 86400, "realtime_ticket": "rt-0195c9a4-5d2e-7abc-8f01-23456789abcd", "player": {"player_id": "0195c9a2-7b1e-7f3a-9d2c-4e5f6a7b8c9d", "username": "MazeRunner_88", "created_at": "2026-07-11T10:30:00Z", "active_title": null, "class_unlocks": ["explorer"], "meld_skills": [{"skill_kind": "forging", "level": 1, "xp": 0}, {"skill_kind": "mercantile", "level": 1, "xp": 0}, {"skill_kind": "alchemy", "level": 1, "xp": 0}]}}
```
...
```json
HTTP/1.1 200 OK
{"player_id": "0195c9a2-7b1e-7f3a-9d2c-4e5f6a7b8c9d", "username": "MazeRunner_88", "created_at": "2026-07-11T10:30:00Z", "active_title": "Tundra Vanguard", "class_unlocks": ["explorer", "dragoon"], "meld_skills": [{"skill_kind": "forging", "level": 22, "xp": 4100}, {"skill_kind": "mercantile", "level": 31, "xp": 900}, {"skill_kind": "alchemy", "level": 8, "xp": 55}]}
```
...
| class_unlocks | array of string (enum: explorer, dragoon, sage, ranger, alchemist_knight, bard) | No | v0.1 | No | Character classes unlocked on the account. |
...
```json
HTTP/1.1 200 OK
{"player_id": "0195c9b0-9f00-7abc-8f01-23456789abcd", "username": "ForgeQueen", "created_at": "2026-05-02T08:15:00Z", "active_title": null, "class_unlocks": ["explorer", "sage", "bard"]}
```
...
| data[].class | string (enum: explorer, dragoon, sage, ranger, alchemist_knight, bard) | No | v0.1 | No | The character class. |
| data[].unlocked | boolean | No | v0.1 | No | Whether the class is unlocked on this account. `explorer` is always `true`. |
| data[].emblem_name | string | Yes | v0.1 | No | The class emblem that grants the unlock (e.g. `"Emblem of the Dragoon"`). `null` for `explorer`, which has no emblem. |
| data[].unlocked_at | string (date-time) | Yes | v0.1 | No | When the emblem was claimed. `null` if not yet unlocked; for `explorer`, equals account creation time. |
