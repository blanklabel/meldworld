...
| class | string (enum: explorer, dragoon, sage, ranger, alchemist_knight, bard) | Yes | No | — | v0.1 | No | The class the caller plays this run. Must be unlocked on the caller's account. |
