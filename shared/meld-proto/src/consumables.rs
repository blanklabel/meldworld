...
pub const CONSUMABLES: &[ConsumableDef] = &[
    ...
    ConsumableDef {
        key: "stagblood_draught",
        name: "Stagblood Draught",
        effect: ConsumableEffect::Heal,
        tier: 1,
        potency: 1,
        description: "Cold, iron-bright, and it smells of frost and antler.",
        only_class: None,
        damage_type: None,
    },
    ConsumableDef {
        ...
        tier: 5,
        potency: 2,
        description: "Bottled current. It hums against the teeth and will not sit still.",
        only_class: None,
        damage_type: None,
    },
    ConsumableDef {
        ...
        tier: 6,
        potency: 3,
        description: "It heals the way the Cradle heals: something new, growing over the hole.",
        only_class: None,
        damage_type: None,
    },
    ConsumableDef {
        ...
        tier: 7,
        potency: 3,
        description: "Warm as a hand on the shoulder. You will want another, and that is the trap.",
        only_class: None,
        damage_type: None,
    },
];
...
pub const RECIPES: &[RecipeDef] = &[
    ...
    // --- The deep world's smelt line. ---
    RecipeDef {
        key: "brass_ingot",
        name: "Brass Ingot",
        inputs: &[("brass_scrap", 2)],
        output: "brass_ingot",
        output_qty: 1,
        skill: "forging",
        min_level: 10,
    ...
    // --- The deep world's trophy line: one draught per biome, and it takes ALL
    // THREE of that biome's parts. A roster of three that fed three separate
    // recipes would mean two of them were optional; taking all three is what makes
    // a biome's whole bestiary worth clearing rather than its easiest species.
    RecipeDef {
        key: "stagblood_draught",
        name: "Stagblood Draught",
        inputs: &[("stag_antler", 1), ("tinder_pelt", 1), ("rook_quill", 1), ("bloom_herb", 1)],
        output: "stagblood_draught",
        output_qty: 1,
        skill: "alchemy",
        min_level: 3,
    },
    RecipeDef {
        key: "arc_flask",
        name: "Arc Flask",
        inputs: &[("sentry_cog", 1), ("coupler_fang", 1), ("arc_residue", 1), ("coolant_bloom", 1)],
        output: "arc_flask",
        output_qty: 1,
        skill: "alchemy",
        min_level: 10,
    ...
    RecipeDef {
        key: "cradle_tonic",
        name: "Cradle Tonic",
        inputs: &[("grub_fat", 1), ("bloat_sac", 1), ("midwife_cap", 1), ("pale_shoot", 1)],
        output: "cradle_tonic",
        output_qty: 1,
        skill: "alchemy",
        min_level: 12,
    ...
    RecipeDef {
        key: "velvet_philtre",
        name: "Velvet Philtre",
        inputs: &[("velvet_strand", 1), ("rose_thorn", 1), ("gilded_collar", 1), ("rose_attar", 1)],
        output: "velvet_philtre",
        output_qty: 1,
        skill: "alchemy",
        min_level: 14,
    },
