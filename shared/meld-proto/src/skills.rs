...
pub const SKILLS: &[SkillDef] = &[
    ...
    SkillDef {
        ...
        unlock: 35,
        target: Target::Party,
        description: "Regen for the WHOLE party, and it costs you nothing. Calms a mind that is not its own: lifts dread and rage.",
        upgrades: None,
        requires: None,
        rank: "",
    },
    SkillDef {
        ...
        unlock: 50,
        target: Target::Ally,
        description: "A large heal for ONE ally, paid from your own HP. Reaches a FALLEN ally and stands them back up.",
        upgrades: None,
        requires: None,
        rank: "",
    },
    ...
    SkillDef {
        ...
        unlock: 5,
        target: Target::Ally,
        description: "Heals an ally now AND grants them Regen after. Draws out venom — poison and burning.",
        upgrades: None,
        requires: None,
        rank: "Seedling",
    },
    ...
    SkillDef {
        ...
        unlock: 50,
        target: Target::Party,
        description: "The capstone: the whole party is healed, shielded, and pushed up the turn order. Rebirth: every fallen ally stands back up.",
        upgrades: None,
        requires: None,
        rank: "Terra",
    },
