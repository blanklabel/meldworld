...
fn city_vault_text(inv: &InventoryData) -> String {
    if !inv.loaded {
...
#[derive(Component)]
struct GearTooltipRoot;

fn render_gear_tooltip(
    mut commands: Commands,
    windows: Query<&Window>,
